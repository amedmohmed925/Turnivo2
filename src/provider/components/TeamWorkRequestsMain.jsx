...
import { getPendingTeam, acceptUser, rejectUser, getTeamMemberDetails } from '../../api/superviserTeamApi';
          ...
          {loading ? (
            ...
            pendingTeam.map((item) => (
              <div className="col-md-6 mb-3" key={item.id}>
                <div className="bg-light-gray p-3 rounded-3 h-100 d-flex gap-2 align-items-center" onClick={() => handleViewProfile(item.id)} style={{cursor: 'pointer'}}>
