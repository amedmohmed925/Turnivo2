...
import DashboardProviderChart1 from './DashboardProviderChart1';
import DashboardProviderChart2 from './DashboardProviderChart2';
import ProviderHeader from './ProviderHeader';

const DashboardProviderMain = ({ onMobileMenuClick }) => {
  return (
    <section>
        <ProviderHeader title="Dashboard" onMobileMenuClick={onMobileMenuClick} />
            ...
            <div className="row">
                <div className="col-md-5 mt-3">
                    <div className='shadow p-3 rounded-4 bg-white h-100'>
                        <DashboardProviderChart1 />
                    </div>
                </div>
                <div className="col-md-7 mt-3">
                    <div className='shadow p-3 rounded-4 bg-white h-100'>
                        <DashboardProviderChart2 />
                    </div>
                </div>
            </div>
        </div>
...
export default DashboardProviderMain;